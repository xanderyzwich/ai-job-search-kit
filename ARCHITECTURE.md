...
- `framework/templates/` and `framework/skills/` are still being extracted from
  the working private instance. The contract in `framework/CONTRACT.md`
  describes the intended shape; not everything it references exists yet.
